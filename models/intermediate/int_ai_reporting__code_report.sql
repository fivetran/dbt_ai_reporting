...
claude as (
    ...
    select
        ...
        'claude' as platform,
        user_id,
        actor_email_address as actor_email,
        ...
        sum(estimated_cost) as claude_estimated_cost,
        max(estimated_cost_currency) as claude_estimated_cost_currency,
        cast(null as {{ dbt.type_float() }}) as openai_credits
    from claude_raw
...
openai as (
    ...
    select
        ...
        cast(null as {{ dbt.type_float() }}) as claude_estimated_cost,
        cast(null as {{ dbt.type_string() }}) as claude_estimated_cost_currency,
        credits as openai_credits
